...
def diagn(ax, statn, prop, sigma_lim = 1.5, sigma_color = 'k', \
  ...
  #ax.set_xticks(np.arange(0., 1.875, .25))
  ax.set_xticks(np.arange(0., 1.625, .25))
  #ax.set_xticklabels(['1.00', '0.75', '0.50', '0.25', '0.00', '0.25', '0.50', '0.75', '1.00'])
  ax.set_xticklabels(['1.00', '0.75', '0.50', '0.25', '0.00', '0.25', '0.50'])
  #ax.set_xticklabels(['1.00', '0.75', '0.50', '0.25', '0.00', '0.25', '0.50', '0.75'])
