...
def get_historical_metadata(model):
    ...
    ['access10','access13','access_cm2','access_esm1_5','awi_esm_1_1_lr','bcc_csm1_1','bcc_csm2_mr','ccsm4','cesm2','cmcc_cm','cmcc_cm2_hr4','cmcc_cm2_sr5','cmcc_esm2','canesm2','canesm5',
    ...
    if model == 'access10':
        ...
        ecs_f = np.nan
        tcr_f = np.nan
    elif model == 'ec_earth3_dcpp':
        fullname_f = 'EC-Earth3 (2019)' #i
        mrun_f = 'dcppA-hindcast'
        doi_f = '10.5194/gmd-2020-446'
        atmos_f = 'IFS cy36r4 (TL255, linearly reduced Gaussian grid equivalent to 512 x 256 longitude/latitude; 91 levels; top level 0.01 hPa)' #i
        surface_f = 'HTESSEL (land surface scheme built in IFS)' #i
        ocean_f = 'NEMO3.6 (ORCA1 tripolar primarily 1 deg with meridional refinement down to 1/3 degree in the tropics; 362 x 292 longitude/latitude; 75 levels; top grid cell 0-1 m)' #i
        seaice_f = 'LIM3' #i
        aerosols_f = 'none' #i
        chemistry_f = 'none' #i
        obgc_f = 'none' #i
        landice_f = 'none' #i
        coupler_f = 'OASIS3-MCT'
        complex_f = '2222101000' #very likely identical to EC-Earth3, but this has not been confirmed by Ralf Döscher and Klaus Wyser
        contact_f= 'Ralf Döscher and Klaus Wyser'
        addinfo_f = 'The global netCDF attribute <source> for this model version is indentical to that obtained from EC-Earth3 (see entry below).'
        family_f = 'gcm'
        cmip_f = 6
        calendar_f = 'gregorian'
        rgb_f = 'yellow'
        ...
        ecs_f = 3.0
        tcr_f = 1.7
    elif model == 'mpi_esm_1_2_hr_dcpp':
        fullname_f = 'MPI-ESM1.2-HR (2017)' #i
        mrun_f = 'dcppA-hindcast'
        doi_f = '10.1029/2018MS001400, 10.5194/gmd-12-3241-2019'
        atmos_f = 'ECHAM6.3 (spectral T127; 384 x 192 longitude/latitude; 95 levels; top level 0.01 hPa)'#i
        surface_f = 'JSBACH3.20' #i
        ocean_f = 'MPIOM1.63 (tripolar TP04, approximately 0.4deg; 802 x 404 longitude/latitude; 40 levels; top grid cell 0-12m)'#i
        seaice_f = 'unnamed (thermodynamic (Semtner zero-layer) dynamic (Hibler 79) sea ice model)'#i
        aerosols_f = 'none, prescribed MACv2-SP' #i
        chemistry_f = 'none' #i
        obgc_f = 'HAMOCC6' #i
        landice_f = 'none/prescribed' #i
        coupler_f = 'OASIS3-MCT'
        complex_f = '2222221020' #is very likely equal to mpi_esm_1_2_hr but has not been confirmed by Thorsten Mauritsen
        contact_f = 'Thorsten Mauritsen'
        addinfo_f = 'The global netCDF attribute <source> for this model version is indentical to that obtained from MPI-ESM1.2-HR (see entry below).'
        family_f = 'esm'
        cmip_f = 6
        calendar_f = 'gregorian'
        rgb_f = '#00FF00'
        ...
        ecs_f = 4.7
        tcr_f = 2.2
    elif model == 'miroc6_dcpp':
        fullname_f = 'MIROC6 (2017)' #i
        mrun_f = 'dcppA-hindcast'
        doi_f = '10.5194/gmd-12-2727-2019'
        atmos_f = 'CCSR AGCM (T85; 256 x 128 longitude/latitude; 81 levels; top level 0.004 hPa)' #i
        surface_f = 'MATSIRO6.0' #i
        ocean_f = 'COCO4.9 (tripolar primarily 1deg; 360 x 256 longitude/latitude; 63 levels; top grid cell 0-2 m)' #i
        seaice_f = 'COCO4.9' #i
        aerosols_f = 'SPRINTARS6.0' #i
        chemistry_f = 'none' #i
        obgc_f = 'none' #i
        landice_f = 'none' #i
        coupler_f = 'inhouse'
        complex_f = '2222102000' # very likely identical to miroc6, but this has not been confirmed by Hiroaki Tatebe yet
        contact_f = 'Hiroaki Tatebe'
        addinfo_f = 'The global netCDF attribute <source> for this model version is indentical to that obtained from EC-Earth3 (see entry below).'
        family_f = 'gcm'
        cmip_f = 6
        ...
        ecs_f = np.nan
        tcr_f = np.nan
    elif model == 'norcpm1_dcpp':
        fullname_f = 'NorCPM1 (2019)'
        mrun_f = 'dcppA-hindcast'
        doi_f = '10.5194/gmd-14-7073-2021'
        atmos_f = 'CAM-OSLO4.1 (based on CAM4, 2 degree resolution; 144 x 96 longitude/latitude; 26 levels; top level ~2 hPa)'
        surface_f = 'CLM4 (same grid as atmos)'
        ocean_f = 'MICOM1.1 (1 degree resolution; 320 x 384 longitude/latitude; 53 levels; top grid cell 0-2.5 m [native model uses hybrid density and generic upper-layer coordinate interpolated to z-level for contributed data])'
        seaice_f = 'CICE4 (same grid as ocean)'
        aerosols_f = 'OsloAero4.1 (same grid as atmos)'
        chemistry_f = 'OsloChemSimp4.1 (same grid as atmos)' #the source entry is probably wrong because atmospheric chemistry is not desecribed in doi:10.5194/gmd-14-7073-2021
        obgc_f = 'HAMOCC5.1 (same grid as ocean)'
        landice_f = 'none'
        coupler_f = 'CPL7'
        complex_f = '2222122000' #has to be confirmed!
        contact_f = 'Øyvind Seland'
        addinfo_f = 'Based on NorESM1-ME. NorCPM1 combines the Norwegian Earth System Model version 1 (NorESM1), which features interactive aerosol–cloud schemes and an isopycnic-coordinate ocean component with biogeochemistry, with anomaly assimilation of sea surface temperature (SST) and T /S-profile observations using the ensemble Kalman filter (EnKF).'
        family_f = 'esm'
        cmip_f = np.nan
        rgb_f = '#FFB6C1'
        marker_f = 'd'
        ...
        aerosols_f = 'CAM-Oslo (CAM4-Oslo-noresm-ver1_cmip5-r112, f19L26)' #revisar
        chemistry_f = 'none'
        obgc_f = 'none'
        landice_f = 'none'
        coupler_f = 'CPL7'
        ...
        ecs_f = np.nan
        tcr_f = 1.7
    #reanalysis datasets used by analysis_hist.py and analysis_ensemble,py
    elif model == 'era5':
        fullname_f = 'ERA5 reanalysis'
        mrun_f = 'r1i1p1'
        family_f = 'reanalysis'
        ...
        ecs_f = np.nan
        tcr_f = np.nan
    elif model == 'era5cs': #entry for ERA5 interpolated with cubic splines instead of bilinear interpolation
        fullname_f = 'ERA5 reanalysis'
        mrun_f = 'r1i1p1'
        family_f = 'reanalysis'
        cmip_f = 1 #this is a fake score in order to be able to work with reanlaysis datasets as if they were GCMs in analysis_hist.py
        ...
        fullname_f = 'ERA-Interim reanalysis'
        mrun_f = 'r1i1p1'
        family_f = 'reanalysis'
        cmip_f = 1 #this is a fake score in order to be able to work with reanlaysis datasets as if they were GCMs in analysis_hist.py
        complex_f = '1000000000' #this is a fake score in order to be able to work with reanlaysis datasets as if they were GCMs in analysis_hist.py
    ...
    # if model not in ('era5','era5cs','interim','jra55'):
