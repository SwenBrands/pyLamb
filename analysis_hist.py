...
if groupby == 'agcm':
    ...
    mylabels = ['GFDL-CM3','GFDL-ESM2G','GFDL-CM4','GFDL-ESM4','KIOST-ESM','CSIRO-MK3.6','ACCESS1.0','ACCESS1.3','ACCESS-CM2','ACCESS-ESM1.5','BCC-CSM1.1','BCC-CSM2-MR','KACE1.0-G','IITM-ESM','HadGEM2-ES','HadGEM2-CC','HadGEM3-GC31-MM','MPI-ESM-LR','MPI-ESM-MR','MPI-ESM1.2-LR','MPI-ESM1.2-HR','MPI-ESM-1-2-HAM','CMCC-CM','CMCC-CM2-SR5','CMCC-CM2-HR4','CMCC-ESM2','CNRM-CM5','CNRM-CM6-1','CNRM-CM6-1-HR','CNRM-ESM2-1','EC-Earth2.3','EC-Earth3','EC-Earth3-Veg','EC-Earth3-Veg-LR','EC-Earth3-AerChem','EC-Earth3-CC','IPSL-CM5A-LR','IPSL-CM5A-MR','IPSL-CM6A-LR','NESM3','AWI-ESM-1-1-LR','CCSM4','SAM0-UNICON','TaiESM1','NorESM1-M','NorESM2-LM','NorESM2-MM','FGOALS-g2','FGOALS-g3','GISS-E2-H','GISS-E2-R','GISS-E2.1-G','MIROC5','MIROC6','MIROC-ESM','MIROC-ES2L','MRI-ESM1','MRI-ESM2.0','INM-CM4','INM-CM5','CanESM2']
...
for mm in range(len(model)):
    ...
    if errortype in ('TPMS','PERS','PERSall'):
        ...
        savepath = tarpath+'/'+experiment[mm]+'/transitions/'+region+'/trans_prob_'+model_plus_run[mm]+'_'+region+'.nc'
        try:
